...
const FlyingBirds: React.FC = () => {
  ...
  const birds: Bird[] = [
    {
      id: 1,
      startX: -500, // За левой границей сайта (увеличено)
      endX: 'calc(100vw + 500px)', // За правой границей сайта (увеличено)
      startY: 100,
    ...
    {
      id: 2,
      startX: 'calc(100vw + 500px)', // За правой границей сайта (увеличено)
      endX: -500, // За левой границей сайта (увеличено)
      startY: 200,
